...
export default function AboutUs() {
    return(
        <div>
            ...
            <p>
                The R3Plastic team is passionate about sustaianability and making a positive impact on the world. We believe small, everyday changes can result in big results, and are commited to doing our part in ensuring the best for our earth.
            </p>
        </div>
    );
}
